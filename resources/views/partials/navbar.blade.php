    ...
    <div class="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
        <div class="lg:flex lg:items-center">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="/">pilput</a>
                </div>
                <!-- Mobile menu button -->
            ...
            <div class="flex flex-col text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
                <a href="/" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 {{($active === "home") ? 'text-blue-600':''}}">Home</a>
                <a href="/blog" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 {{($active === "blog") ? 'text-blue-600':''}}">Blog</a>
                <a href="/about" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 {{($active === "about") ? 'text-blue-600':''}}">About</a>
