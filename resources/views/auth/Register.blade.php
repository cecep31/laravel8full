...
@section('content')
    <div class="flex flex-col">
        ...
        <div class="flex bg-green-lighter max-w-sm mb-4">
            ...
            <div class="w-auto text-grey-darker items-center p-4">
                ...
                <p class="leading-tight">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab beatae consequuntur dolore doloribus eius
        ...
        <div class="flex bg-teal-lighter max-w-sm mb-4">
            ...
            <div class="w-auto text-gray-600 items-center p-4">
                <span class="text-lg font-bold pb-4">
                    Heads Up!
                </span>
                <p class="leading-tight">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis, labore, voluptatem. Deserunt illum
                    laborum maxime?
                </p>
            </div>
        </div>
    ...
    <form class="p-10 bg-white rounded flex justify-center items-center flex-col shadow-md" action="/register"
        method="POST">
        @csrf
